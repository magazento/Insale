...
--
-- Table structure for table `ip_tabs_tab`
--

CREATE TABLE IF NOT EXISTS `ip_tabs_tab` (
...
--
-- Dumping data for table `ip_tabs_tab`
--

INSERT INTO `ip_tabs_tab` (`tab_id`, `title`, `url`, `content`, `type`, `position`, `align_tab`, `css_style`, `css_class`, `css_style_content`, `css_class_content`, `from_time`, `to_time`, `is_active`) VALUES
...
--
-- Table structure for table `ip_tabs_tab_store`
--

CREATE TABLE IF NOT EXISTS `ip_tabs_tab_store` (
  `tab_id` smallint(6) unsigned DEFAULT NULL,
  `store_id` smallint(6) unsigned DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `ip_tabs_tab_store`
--

INSERT INTO `ip_tabs_tab_store` (`tab_id`, `store_id`) VALUES
(13, 0),
(14, 0),
(15, 0),
(16, 0),
