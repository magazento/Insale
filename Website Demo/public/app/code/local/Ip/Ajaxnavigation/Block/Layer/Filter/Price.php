<?php
class Ip_Ajaxnavigation_Block_Layer_Filter_Price extends Ip_Ajaxnavigation_Block_Layer_Filter_Abstract
{
    /**
    ...
    {
        parent::__construct();
        $this->setTemplate('ip_ajaxnavigation/layer/price.phtml');
