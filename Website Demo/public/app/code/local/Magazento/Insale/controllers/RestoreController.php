 ...
 *
 */
class Magazento_Insale_RestoreController extends Mage_Adminhtml_Controller_Action
{
    public function indexAction()
    {
     ...
     $this->loadLayout(array('default'));
		...
		$this->_addContent($this->getLayout()->createBlock('insale/adminhtml_restore_edit'));
		$this->renderLayout();
    }
    ...
    public function saveAction() {
        ...
        try {
            ...
            if ($clear_scope) {
                foreach ($stores as $store) {
                    Mage::getModel('insale/template')->setDefaultSettings($scope, $store);
                }
            }
